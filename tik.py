...
class Zefoy:
	...
	def __init__(self):
		...
		self.url = 'None'
		self.text = 'DreykoV '
		url1=input("\x1b[0;30;47mDrey\x1b[0;30;101mKoV\x1b[0m >>> [Nhập Link Video] ")
		self.url=url1
	...
	def get_captcha(self):
		...
		try:
			...
			print('\x1b[0;30;47mDrey\x1b[0;30;101mKoV\x1b[0m >>>   Đang giải captcha..')
			return False
		except Exception as e:
			print(f"\x1b[0;30;47mDrey\x1b[0;30;101mKoV\x1b[0m >>>   Không thể giải captcha: {e}")
			time.sleep(2)
			self.get_captcha()

	def send_captcha(self, new_session = False):
		if new_session: self.session = requests.Session(); os.remove('session'); time.sleep(2)
		if self.get_captcha(): print('\x1b[0;30;47mDrey\x1b[0;30;101mKoV\x1b[0m >>>   Đang kết nối đến session');return (True, 'The session already exists')
		...
		if 'Enter Video URL' in request.text: 
			print('\x1b[0;30;47mDrey\x1b[0;30;101mKoV\x1b[0m >>>   Session đã được tạo')
			open('session','w',encoding='utf-8').write(self.session.cookies.get('PHPSESSID'))
			print(f"\x1b[0;30;47mDrey\x1b[0;30;101mKoV\x1b[0m >>>   Giải capcha thành công: {captcha_solve}")
	...
	def find_video(self):
		...
		while True:
			...
			if 'Session expired. Please re-login' in self.video_info: print('\x1b[0;30;47mDrey\x1b[0;30;101mKoV\x1b[0m >>>   Phiên hết hạn. Đang đăng nhập lại...');self.send_captcha(); return
			elif 'service is currently not working' in self.video_info: return (True,'\x1b[0;30;47mDrey\x1b[0;30;101mKoV\x1b[0m >>>   Dịch vụ hiện không hoạt động, hãy thử lại sau. | Bạn có thể thay đổi nó trong cấu hình.')
				...
				elif lamtilo >= 1000: print('\x1b[0;30;47mDrey\x1b[0;30;101mKoV\x1b[0m >>>   Your IP was banned')
				# print(f'\x1b[0;30;47mDrey\x1b[0;30;101mKoV\x1b[0m >>>   Thời gian chờ để tiếp tục tăng: {t} giây')
				# for lam in range(t,0,-1):
				# 	lam-=1
				# 	print(f"\x1b[0;30;47mDrey\x1b[0;30;101mKoV\x1b[0m >>>   Vui lòng chờ: {lam}",end="\r")
				# 	time.sleep(1)
				_=time.time()
				while time.time()-2<_+lamtilo:
					t-=1
					print("\x1b[0;30;47mDrey\x1b[0;30;101mKoV\x1b[0m >>>   Vui lòng chờ: {0} ".format(t)+"giây .", end="\r")
					time.sleep(1)
	...
	def use_service(self):
		...
		if 'Session expired. Please re-login' in res: print('\x1b[0;30;47mDrey\x1b[0;30;101mKoV\x1b[0m >>>   Phiên hết hạn. Đang đăng nhập lại...');self.send_captcha(); return ""
		elif 'Too many requests. Please slow' in res: time.sleep(3)
		elif 'service is currently not working' in res: return ('\x1b[0;30;47mDrey\x1b[0;30;101mKoV\x1b[0m >>>   Dịch vụ hiện không hoạt động, hãy thử lại sau. | Bạn có thể thay đổi nó trong cấu hình.')
	...
	def get_video_id(self, url_ = None, set_url=True):
		...
		if request.text == '': print('\x1b[0;30;47mDrey\x1b[0;30;101mKoV\x1b[0m >>>   Link video không hợp lệ'); return False
	...
	def update_name(self):
		while True:
			try:
				...
				self.text = f"\x1b[0;30;47mDrey\x1b[0;30;101mKoV\x1b[0m >>>   | Views: {video_info['viewCount']} "
			except: pass
			time.sleep(5)
trang = "\033[1;37m"
xanh_la = "\033[1;32m"
...
\033[1;37m           ▀▀ █▪ ▀▀▀ . ▀      •▀▀ ▀▀     ▀▀▀ ▀▀▀·▀  ▀
\033[1;35m────────────────────────────────────────────────────────────
              {do}{trang} {dac_biet}BOT VIEW By Ng Thanh Vinh 
              {do}{trang} \033[1;35mADMIN    :\033[1;36m NGUYEN THANH VINH
              {do}{trang} \033[1;31mZALO     :\033[1;33m 0927423139
              {do}{trang} \033[1;33mTELEGRAM :\033[1;37m @iamDreyKoV
\033[1;35m────────────────────────────────────────────────────────────\n"""
...
#     print(f"\x1b[0;30;47mDrey\x1b[0;30;101mKoV\x1b[0m >>> Link key: {link1}")
     
# else:
#     link1=""
# nhap = input(f"\x1b[0;30;47mDrey\x1b[0;30;101mKoV\x1b[0m >>> Nhập key vừa lấy được: ")
# if nhap == key:
if 1:
    print(f"\x1b[0;30;47mDrey\x1b[0;30;101mKoV\x1b[0m >>> Key đúng mời bạn vô tool")
    logo()
    Z = Zefoy()
    ...
    print(f"\x1b[0;30;47mDrey\x1b[0;30;101mKoV\x1b[0m >>> Key sai vui lòng vượt lại")
    exit()

while True:
	try: 
		if 'Service is currently not working, try again later' in str(Z.use_service()): print(f'{do}\x1b[0;30;47mDrey\x1b[0;30;101mKoV\x1b[0m >>>  Dịch vụ hiện không hoạt động, hãy thử lại sau. | Bạn có thể thay đổi nó trong cấu hình.');time.sleep(5)
